...
# -*- coding: utf-8 -*-
#
# the HiPERCAM pipeline documentation build configuration file, created by
# sphinx-quickstart on Wed Oct 25 19:37:05 2017.
#
...
project = 'HiPERCAM pipeline'
copyright = '2017, T.R. Marsh'
author = 'T.R. Marsh'
...
print(f"[Sphinx] Building documentation for HiPERCAM pipeline version: {release}")
...
htmlhelp_basename = 'theHiPERCAMpipelinedoc'
...
latex_documents = [
    (master_doc, 'theHiPERCAMpipeline.tex', 'the HiPERCAM pipeline Documentation',
     'T.R. Marsh', 'manual'),
]
...
man_pages = [
    (master_doc, 'thehipercampipeline', 'the HiPERCAM pipeline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'theHiPERCAMpipeline', 'the HiPERCAM pipeline Documentation',
     author, 'theHiPERCAMpipeline', 'One line description of project.',
     'Miscellaneous'),
]
